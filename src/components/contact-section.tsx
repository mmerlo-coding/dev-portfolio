...
import { ParticlesBackground } from "./animated-background"
...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="py-20 md:py-32 bg-muted/50 relative overflow-hidden">
      {/* Animated background */}
      <ParticlesBackground particleColor="hsl(var(--primary)/30)" count={30} />
