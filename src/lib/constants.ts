...
export const projects = [
    ...
    },
    {
      ...
      liveUrl: "https://timeprime.vercel.app/",
      githubUrl: "https://github.com/mmerlo-coding",
    },
    {
    ...
    },
    {
      ...
      tags: ["Next.js", "Tailwind CSS", "React", "Webhooks", "Persistent Storage", "Firebase", "Firestore"],
      liveUrl: "https://modernbizhub.vercel.app",
      githubUrl: "https://github.com/Alejandromcad13/modernbizhub-blog",
    },
    {
...
export const tagIcons: { [key: string]: React.FC<LucideProps> } = {
    "Next.js": DatabaseZap,
    React: DatabaseZap,
    ...
    OpenAI: BrainCircuit,
    PostgreSQL: Database,
    "Sanity CMS": Database, // Using generic DB icon
    ShadCN: Component,
    "Framer Motion": Zap,
    "Chart.js": BarChart,
  };